...
namespace HW02
{
    ...
    {
        const string connectionString = "Server=DESKTOP-REVRHUK;Database=CustomerDb;Integrated Security=SSPI;TrustServerCertificate=true";

        private Dictionary<int, string> optionsDictionary = new Dictionary<int, string>
        {
            { (int)Display.AllCustomers, "All customers" },
            { (int)Display.EmailsAndCustomers, "All emails and customers" },
